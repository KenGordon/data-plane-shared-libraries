...
#ifndef CPIO_CLIENT_PROVIDERS_AUTH_TOKEN_PROVIDER_SRC_AZURE_AZURE_AUTH_TOKEN_PROVIDER_H_
 ...
 */
class AadAuthTokenProvider : public AuthTokenProviderInterface {
 public:
  AadAuthTokenProvider(
...
#endif  // CPIO_CLIENT_PROVIDERS_AUTH_TOKEN_PROVIDER_SRC_AZURE_AZURE_AUTH_TOKEN_PROVIDER_H_
