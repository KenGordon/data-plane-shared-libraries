...
DEFINE_ERROR_CODE(SC_AZURE_INSTANCE_AUTHORIZER_PROVIDER_INITIALIZATION_FAILED,
                  ...
                  "Cannot initialize the AAD instance authorizer provider.",
...
MAP_TO_PUBLIC_ERROR_CODE(SC_AZURE_INSTANCE_AUTHORIZER_PROVIDER_BAD_SESSION_TOKEN,
                         SC_CPIO_INVALID_RESOURCE)
}  // namespace google::scp::core::errors

#endif  // CPIO_CLIENT_PROVIDERS_AUTH_TOKEN_PROVIDER_SRC_AZURE_ERROR_CODES_H_
